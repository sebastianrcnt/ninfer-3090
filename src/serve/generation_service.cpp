...
GenerationService::GenerationService(ServeOptions options, LoadProgress load_progress)
    ...
    engine_options.conversation_cache_dir        = options_.conversation_cache_dir;
    engine_options.conversation_cache_disk_bytes = options_.conversation_cache_disk_mib << 20;
