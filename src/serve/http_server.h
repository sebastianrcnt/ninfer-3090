...
private:
    ...
    void handle_conversations(const httplib::Request& req, httplib::Response& res) const;
    void handle_conversation_erase(const httplib::Request& req, httplib::Response& res);
    ...
    void attach_admission_log(PreparedRequest& prepared, const RequestLogContext& context);
    void log_request_admitted(const RequestLogContext& context, const ninfer::GenerationPlan& plan);
